...
// ---------- Basic DB config (EDIT if needed) ----------
...
@$conn->query("SET time_zone = '+08:00'"); // Asia/Manila (+08:00)
...
define('LOGIN_URL', BASE_URI.'/login.php');
define('ADMIN_LOGIN_URL', BASE_URI.'/admin/login.php');
